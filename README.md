...
Command	Description
$env:TEST_ENV="prod"; npm run test:chromium	Run tests in Chromium
$env:TEST_ENV="prod"; npm run test:firefox	Run tests in Firefox
$env:TEST_ENV="prod"; npm run test:webkit	Run tests in WebKit (Safari engine)
